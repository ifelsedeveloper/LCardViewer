...
namespace WindowsExplorer
{
	...
	public class ExplorerTree : System.Windows.Forms.UserControl
	{
		...
		private void InitializeComponent()
		{
            ...
            this.toolTip1.SetToolTip(this.btnRefresh, "Обновление дерева Проводника");
            ...
            this.toolTip1.SetToolTip(this.btnGo, "Перейти к директории");
            ...
            this.toolTip1.SetToolTip(this.btnHome, "Каталог приложения");
            ...
            this.toolTip1.SetToolTip(this.btnBack, "Назад");
            ...
            this.toolTip1.SetToolTip(this.btnNext, "Вперёд");
            ...
            this.toolTip1.SetToolTip(this.btnUp, "Родительский каталог");
            ...
            this.toolTip1.SetToolTip(this.btnAdd, "Добавить ярлык к часто используемым папкам");
